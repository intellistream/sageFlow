...
struct PipelineConfig {
  ...
  struct Window { int64_t time_ms; int64_t trigger_interval_ms; } window;
  struct IVFConfig { int nlist; int nprobes; double rebuild_threshold; } ivf;
  struct DataPattern { int positive_pairs; int near_threshold_pairs; int negative_pairs; int random_tail; uint32_t seed; } data_pattern;
};
