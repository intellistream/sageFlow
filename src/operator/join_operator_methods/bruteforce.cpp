...
std::vector<std::unique_ptr<VectorRecord>> BruteForceJoinMethod::ExecuteLazy(const std::list<std::unique_ptr<VectorRecord>> &query_records, int query_slot) {
