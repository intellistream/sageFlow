...
Define how SageFlow materializes similarity join results as zero-copy pair references for downstream consumers, while preserving legacy concatenated-record behavior for compatibility.
